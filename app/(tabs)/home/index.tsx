        ...
        <View style={styles.container}>
          <View style={{ marginBottom: 20 }}>
            ...
            <Button mode='outlined' onPress={() => setApiUrl("http://"+inputUrl.trim().toLowerCase()+":8080")}>set url</Button> */}
              ...
              <View style={{ paddingVertical: 0, borderWidth: 1, borderColor: theme.colors.primary, borderRadius: 50, display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
